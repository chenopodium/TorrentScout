 ...
 *
 * Created on 06.04.2011, 13:55:45
 */

package com.iontorrent.panels;
...
import com.iontorrent.wellmodel.WellFlagFilter;
 ...
 * @author Chantal Roth
 */
public class WellFilterPanel extends javax.swing.JPanel {

   WellContext context;
    /** Creates new form WellFilterPanel */
    public WellFilterPanel(WellContext context) {
        initComponents();
    ...
    public void setSelected(ArrayList<WellFilter> filters) {
        ...
        for (WellFilter f: filters) {
            if (f instanceof WellFlagFilter) {
                BfMaskFlag flag = ((WellFlagFilter)f).getFlag();
                jList1.setSelectedValue(flag, false);
            }
        }
    }
    public void setSelectedFlags(ArrayList<BfMaskFlag> flags) {
        if (flags == null) return;
        for (BfMaskFlag f: flags) {           
    ...
    public ArrayList<WellFilter> getSelectedFilters() {
        ...
        for (int i = 0; i < selected.length; i++)        {
            BfMaskFlag flag = (BfMaskFlag)selected[i];
            WellFlagFilter fil = new WellFlagFilter(flag);
            filters.add(fil);
        }
        return filters;
    }
     public ArrayList<BfMaskFlag> getSelectedFlags() {
        ArrayList<BfMaskFlag>  flags = new ArrayList<BfMaskFlag> ();
        Object[] selected = jList1.getSelectedValues();
        for (int i = 0; i < selected.length; i++)        {
            BfMaskFlag flag = (BfMaskFlag)selected[i];
            flags.add(flag);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(WellFilterPanel.class, "WellFilterPanel.jPanel1.border.title"))); // NOI18N
