 ...
 * @author Chantal Roth
 */
public class SubtractPanel extends JPanel {

    private FlowListener list;

    public SubtractPanel() {
    }
    ...
    public SubtractPanel(FlowListener list) {
        initComponents();
        this.list = list;
    }
    ...
    public String getText() {
        return txtFlow.getText();
    }
    public ArrayList<Integer> getFlows() {
        // check for -
        String s= txtFlow.getText();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(SubtractPanel.class, "SubtractPanel.jLabel1.text")); // NOI18N

        txtFlow.setColumns(8);
        txtFlow.setText(org.openide.util.NbBundle.getMessage(SubtractPanel.class, "SubtractPanel.txtFlow.text")); // NOI18N
        txtFlow.setToolTipText(org.openide.util.NbBundle.getMessage(SubtractPanel.class, "SubtractPanel.txtFlow.toolTipText")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtFlow, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
