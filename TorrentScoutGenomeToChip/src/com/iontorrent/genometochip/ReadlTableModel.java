...
public class ReadlTableModel extends DefaultTableModel {
    ...
    public ReadlTableModel(ArrayList<Read> reads, long genomepos) {
        super();
        this.reads = reads;
    ...
    private void createHeader() {
        //                      0        1       2       3       4              5                    6          7        8
        HEADER = new String[]{"row", "col", "reverse", "seq len", "pos in read", "pos in alignment", "flow #", "base", "alignment info"};
    ...
    //                      0        1       2       3       4              5                    6     7        8
    //  HEADER = new String[]{"row", "col", "reverse", "len", "pos in read", "pos in alignment", "flow #", "base", "al info"};
    @Override
