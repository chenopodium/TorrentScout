...
public class WellCoordinate implements Serializable {
    ...
    public WellCoordinate(WellCoordinate c){
        this(c.getCol(), c.getRow());
        this.maskdata = c.maskdata;
        this.scoredata = c.scoredata;
    }
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof WellCoordinate)) {
            return false;
        }
