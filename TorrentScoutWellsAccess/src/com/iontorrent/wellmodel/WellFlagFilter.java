 ...
 * @author Chantal Roth
 */
public class WellFlagFilter extends WellFilter{

    
    BfMaskFlag flag;
    
    public WellFlagFilter(BfMaskFlag flag) {
        super(flag.getName(), "Filter for "+flag.getDescription());
        this.flag = flag;
    }
  public BfMaskFlag getFlag() {
        return flag;
    }
