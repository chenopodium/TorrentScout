...
public abstract class Directions {
    ...
    private void err(String msg, Exception ex) {
        Logger.getLogger(Directions.class.getName()).log(Level.SEVERE, msg, ex);
    }

    private void err(String msg) {
        Logger.getLogger(Directions.class.getName()).log(Level.SEVERE, msg);
    }

    private void warn(String msg) {
        Logger.getLogger(Directions.class.getName()).log(Level.WARNING, msg);
    }
