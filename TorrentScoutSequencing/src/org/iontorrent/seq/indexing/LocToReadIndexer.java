 ...
 * @author Chantal Roth
 */
public class LocToReadIndexer extends AbstractLargeIndexer {

    // a, b, c,d,e,f, g, h, i, j, k, l, m,n, o, p, q ,r,s,t, u, v, w, x, y, z
    // the path that the output is written to
    protected String indexpath;
    protected static long BUCKET_SIZE = 8000;
    private String INDEXFILENAME = "loctoread.idx";
    ...
    public void createLocToReadIndex() {
        long begin = System.currentTimeMillis();

        p("createLocToReadIndex: processing getReadLocationsFileName "+getReadLocationsFileName());
    ...
    //    p("Nr chunks: " + nr_chunks);
        ...
        try {
            while (readloc_file.getFilePointer() < readloc_file.length()) {
              ...
              //  if (nrrows % 100000 == 0) p("Processing line: " + line);
                updateLine(map, line);
    ...
    private static void err(String msg, Exception ex) {
        Logger.getLogger(LocToReadIndexer.class.getName()).log(Level.SEVERE, msg, ex);
    }

    private void err(String msg) {

        Logger.getLogger(LocToReadIndexer.class.getName()).log(Level.SEVERE, msg);
    }

    private static void warn(String msg) {
        Logger.getLogger(LocToReadIndexer.class.getName()).log(Level.WARNING, msg);
    }
