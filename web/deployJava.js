...
var deployJava={
    ...
    EarlyAccessURL:null,
    getJavaURL:'http://java.com/inc/BrowserRedirect?host=java.com',
    appleRedirectPage:'http://www.apple.com/support/downloads/',
    oldMimeType:'application/npruntime-scriptable-plugin;DeploymentToolkit',
    mimeType:'application/java-deployment-toolkit',
    launchButtonPNG:'webstart.png',
    browserName:null,
    browserName2:null,
    getJREs:function(){
        var list=new Array();
...
createMasterLaunch:function(initialheap, maxheap){
    var dir = location.href.substring(0, location.href.lastIndexOf('/')+1);
    var jnlp = dir + "master.jnlp?initial="+initialheap+"&max="+maxheap;
    if(deployJava.returnPage==null){
       deployJava.returnPage=jnlp;
    }
...
openMasterLaunch:function(initialheap, maxheap){
    var dir = location.href.substring(0, location.href.lastIndexOf('/')+1);
    var jnlp = dir + "master.jnlp?initial="+initialheap+"&max="+maxheap;
    if(deployJava.returnPage==null){
       deployJava.returnPage=jnlp;
...
processSelection:function(v) {
  ...
  switch(v) {
    case "1":
      ...
      break;
    case "2":
      deployJava.openMasterLaunch('768m', '1200m');
      break;    
	case "3":
      deployJava.openMasterLaunch('1024m', '2048m');
      break;    
	case "4":
      deployJava.openMasterLaunch('2048m', '3000m');
      break;    
	case "5":
      deployJava.openMasterLaunch('2048m', '4096m');
      break;    
	case "6":
      deployJava.openMasterLaunch('3000m', '5500m');
      break;    
	case "7":
      deployJava.openMasterLaunch('4096m', '6500m');
      break;
    }
  },
